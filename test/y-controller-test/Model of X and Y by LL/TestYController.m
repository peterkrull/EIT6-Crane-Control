  ...
  figure(1)
  q = plot(closedLoop1.tout, closedLoop1.L-0.1,(down_container.Var1/1000)-225+0.85,down_container.Var2-0.1,1.342,0.04,'o',2.293,0.41,'o',settlex1,settley1,settlex2,settley2)
  grid on
  text(1.4,0.04,'10% t = 1.3 s','HorizontalAlignment','left','VerticalAlignment','top')
  text(2.5,0.4,'90% t = 2.3 s','HorizontalAlignment','left','VerticalAlignment','top')
  text(0.1,0.46+0.02,'Error band \pm 4%','HorizontalAlignment','left','VerticalAlignment','top')
  text(2.5,0.3-0.05,'Rise time = 1.0 s','HorizontalAlignment','left','VerticalAlignment','top')
  text(2.5,0.25-0.05,'Settling time = 1.5 s','HorizontalAlignment','left','VerticalAlignment','top')
  q(3).LineWidth = 5;
  q(3).Color='#EDB120';
  q(4).LineWidth = 5;
  q(4).Color='#EDB120';
...
%% Up with container
  ...
  figure(2)
  q = plot(closedLoop2.tout, closedLoop2.L-0.1,(up_container.Var1/1000)-290.25+2.32+1,up_container.Var2-0.1,2.55,0.046,'o',1.282,0.41,'o',settlex1,settley1,settlex2,settley2)
  grid on
...
%% Down without container
  ...
  figure(3)
  q = plot(closedLoop3.tout, closedLoop3.L,(down_no_container.Var1/1000)-9.1-11.2,down_no_container.Var2,1.643,0.12,'o',3.452,1.12,'o',settlex1,settley1,settlex2,settley2)
  grid on
  text(3.2+0.3,1,'90% t = 3.5 s','HorizontalAlignment','left','VerticalAlignment','top')
  ...
  text(3,0.3+0.35,'Rise time = 1.9 s','HorizontalAlignment','left','VerticalAlignment','top')
  text(3,0.2+0.35,'Settling time = 2.6 s','HorizontalAlignment','left','VerticalAlignment','top')
  q(3).LineWidth = 5;
  q(3).Color='#EDB120';
  q(4).LineWidth = 5;
  q(4).Color='#EDB120';
...
%% Up without container
  ...
  figure(4)
  q = plot(closedLoop4.tout, closedLoop4.L,(up_no_container.Var1/1000)-8.7-86,up_no_container.Var2,3.462,0.12,'o',1.672,1.12,'o',settlex1,settley1,settlex2,settley2)
  grid on
  text(3.52,0.35,'90% t = 3.5 s','HorizontalAlignment','left','VerticalAlignment','top')
  ...
  text(3,0.3+0.35,'Rise time = 1.8 s','HorizontalAlignment','left','VerticalAlignment','top')
  text(3,0.2+0.35,'Settling time = 2.7 s','HorizontalAlignment','left','VerticalAlignment','top')
  q(3).LineWidth = 5;
  q(3).Color='#EDB120';
  q(4).LineWidth = 5;
  q(4).Color='#EDB120';
