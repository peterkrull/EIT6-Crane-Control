...
title('With container with controller')
grid on
...
ylabel('Magnitude ')
legend('10 cm','30 cm','50 cm','70 cm','90 cm','110 cm')
title('Without container with controller')
grid on
...
exportgraphics(gcf,'fft_without_container_with_controller.pdf','ContentType','vector')
...
% Without container
freq_peak_without_container = [2.14286, 2.16216, 1.89911, 1.97674, 1.73913, 2.14286];
...
exportgraphics(gcf,'length_to_freq_without_container_with_controller.pdf','ContentType','vector')
