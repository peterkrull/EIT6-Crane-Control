...
figure(3)
plot(length_peak_with_container,freq_peak_with_container,'o',x1,y1)
xlabel('Wire length [m]')
ylabel('Frequency [Hz]')
legend('Measurements','Regression')
title('With container')
grid on
...
figure(4)
plot(length_peak_without_container,freq_peak_without_container,'o',x2,y2)
xlabel('Wire length [m]')
ylabel('Frequency [Hz]')
legend('Measurements','Regression')
title('Without container')
